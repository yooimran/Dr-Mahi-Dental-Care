    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {doctors.map((doctor) => (
            <div key={doctor.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="p-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {Object.entries(selectedDoctor.schedule).map(([day, time]) => (
                        <div key={day} className="flex justify-between bg-gray-50 dark:bg-gray-700 p-2 rounded">
        ...
        <div className="bg-blue-50 dark:bg-blue-900/30 rounded-lg p-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">১৫+</div>
              <div className="text-gray-600 dark:text-gray-300">বছরের অভিজ্ঞতা</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">১২+</div>
              <div className="text-gray-600 dark:text-gray-300">বিশেষ সেবা</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">৫০০০+</div>
              <div className="text-gray-600 dark:text-gray-300">সফল চিকিৎসা</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">৯৮%</div>
              <div className="text-gray-600 dark:text-gray-300">রোগীর সন্তুষ্টি</div>
            </div>
          </div>
        </div>
      </div>
